...
export const ridePods: RidePod[] = [
  ...
  },
  {
    ...
    upcomingRideInstances: [
      ...
      {
        id: "campus-commute-442-2026-05-26-outbound",
        recurringTemplateId: "campus-commute-442",
        instanceDate: "2026-05-26",
        displayDate: "Tue May 26",
        departureTime: "8:00 AM",
        legType: "outbound",
        originLabel: "USC Village",
        destinationLabel: "LAX Terminal 3",
      ...
      {
        id: "campus-commute-442-2026-06-02-outbound",
        recurringTemplateId: "campus-commute-442",
        instanceDate: "2026-06-02",
        displayDate: "Tue Jun 02",
        departureTime: "8:00 AM",
        legType: "outbound",
        originLabel: "USC Village",
        destinationLabel: "LAX Terminal 3",
      ...
      {
        id: "campus-commute-442-2026-06-09-outbound",
        recurringTemplateId: "campus-commute-442",
        instanceDate: "2026-06-09",
        displayDate: "Tue Jun 09",
        departureTime: "8:00 AM",
        legType: "outbound",
        originLabel: "USC Village",
        destinationLabel: "LAX Terminal 3",
      ...
      },
      {
        ...
        recurringTemplateId: "campus-commute-442",
        instanceDate: "2026-06-23",
        displayDate: "Tue Jun 23",
        departureTime: "8:00 AM",
        legType: "outbound",
        originLabel: "USC Village",
        destinationLabel: "LAX Terminal 3",
      ...
      },
      {
        ...
        recurringTemplateId: "campus-commute-442",
        instanceDate: "2026-06-30",
        displayDate: "Tue Jun 30",
        departureTime: "8:00 AM",
        legType: "outbound",
        originLabel: "USC Village",
        destinationLabel: "LAX Terminal 3",
  ...
  {
    id: "taxi-partner-quote-demo",
    type: "recurring",
    title: "Taxi partner quote beta pod",
    fromLabel: "Central",
    toLabel: "HKUST",
    pickupHub: "Central taxi stand",
    dropoffHub: "HKUST North Gate",
    date: "Starts Jun 2, 2026",
    time: "7:45 AM",
    timeFlexibility: "+/- 10 min",
    recurrenceRule: "Tue weekly",
    recurringDays: ["Tue"],
    ...
    hostUserId: "u1",
    backupHostUserId: "u4",
    lockDeadline: "Weekly by Monday 8:00 PM",
    cancellationDeadline: "Weekly by Monday 6:00 PM",
    members: [
      {
        userId: "u1",
        role: "host",
    ...
    upcomingRideInstances: [
      {
        id: "taxi-partner-quote-demo-needed",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-06-02",
        displayDate: "Tue Jun 02",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        status: "quote_needed",
        proofStatus: "NOT_REQUIRED",
        bookingFareCapCents: 28000,
        taxiPartnerQuoteRequestId: "taxi_partner_quote_needed",
      },
      {
        id: "taxi-partner-quote-demo-received",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-06-09",
        displayDate: "Tue Jun 09",
        departureTime: "7:45 AM",
        ...
        originLabel: "Central",
        destinationLabel: "HKUST",
        status: "quote_under_review",
        proofStatus: "NOT_REQUIRED",
        quotedFareCents: 24000,
        bookingFareCapCents: 28000,
        taxiPartnerQuoteRequestId: "taxi_partner_quote_received",
      },
      {
        id: "taxi-partner-quote-demo-accepting",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-06-16",
        displayDate: "Tue Jun 16",
        departureTime: "7:45 AM",
        ...
        quotedFareCents: 24000,
        bookingFareCapCents: 28000,
        taxiPartnerQuoteRequestId: "taxi_partner_guests_accepting",
      },
      {
        id: "taxi-partner-quote-demo-ready",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-06-23",
        displayDate: "Tue Jun 23",
        departureTime: "7:45 AM",
        ...
        quotedFareCents: 24000,
        bookingFareCapCents: 28000,
        taxiPartnerQuoteRequestId: "taxi_partner_ready",
      },
      {
        id: "taxi-partner-quote-demo-payout-pending",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-06-30",
        displayDate: "Tue Jun 30",
        departureTime: "7:45 AM",
        ...
        proofStatus: "VERIFIED",
        quotedFareCents: 24000,
        finalFareCents: 24000,
        bookingFareCapCents: 28000,
        settlementState: "DISPUTE_WINDOW",
        payoutState: "PENDING",
        disputeWindowEndsAt: "2026-07-03T07:45:00.000Z",
        taxiPartnerQuoteRequestId: "taxi_partner_completed_payout_pending",
      },
      {
        id: "taxi-partner-quote-demo-dispute-review",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-07-07",
        displayDate: "Tue Jul 07",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        disputeRaised: true,
        disputeReason: "Wrong pickup point",
        disputeNote: "Guest reported pickup confusion. Manual review placeholder only.",
        taxiPartnerQuoteRequestId: "taxi_partner_dispute_review",
      },
      {
        id: "taxi-partner-quote-demo-payout-ready",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-07-14",
        displayDate: "Tue Jul 14",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        settlementState: "DISPUTE_REVIEW",
        payoutState: "PENDING",
        taxiPartnerQuoteRequestId: "taxi_partner_payout_ready",
      },
      {
        id: "taxi-partner-quote-demo-more-info-needed",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-07-21",
        ...
        settlementState: "DISPUTE_REVIEW",
        payoutState: "HELD_FOR_REVIEW",
        taxiPartnerQuoteRequestId: "taxi_partner_more_info_needed",
      },
      {
        id: "taxi-partner-quote-demo-under-review",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-07-28",
        displayDate: "Tue Jul 28",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        settlementState: "DISPUTE_REVIEW",
        payoutState: "HELD_FOR_REVIEW",
        taxiPartnerQuoteRequestId: "taxi_partner_under_review",
      },
      {
        id: "taxi-partner-quote-demo-payout-denied",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-08-04",
        displayDate: "Tue Aug 04",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        settlementState: "DISPUTE_REVIEW",
        payoutState: "HELD_FOR_REVIEW",
        taxiPartnerQuoteRequestId: "taxi_partner_payout_denied",
      },
      {
        id: "taxi-partner-quote-demo-dispute-resolved",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-08-11",
        displayDate: "Tue Aug 11",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        settlementState: "PAID",
        payoutState: "PAID",
        taxiPartnerQuoteRequestId: "taxi_partner_dispute_resolved",
      },
      {
        id: "taxi-partner-quote-demo-closed",
        recurringTemplateId: "taxi-partner-quote-demo",
        instanceDate: "2026-08-18",
        displayDate: "Tue Aug 18",
        departureTime: "7:45 AM",
        legType: "outbound",
        originLabel: "Central",
        destinationLabel: "HKUST",
        ...
        settlementState: "PAID",
        payoutState: "PAID",
        taxiPartnerQuoteRequestId: "taxi_partner_closed",
      },
    ],
  },
];
