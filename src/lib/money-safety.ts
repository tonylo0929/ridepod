...
export const AUDIT_EVENT_TYPES = [
  ...
  "RIDE_INSTANCE_QUOTE_SUBMITTED",
  "RIDE_INSTANCE_QUOTE_APPROVED",
  "RIDE_INSTANCE_QUOTE_ABOVE_CAP",
  "RIDE_INSTANCE_RECEIPT_SUBMITTED",
  "RIDE_INSTANCE_METER_PROOF_SUBMITTED",
  "RIDE_INSTANCE_PROOF_CERTIFIED",
  "RIDE_INSTANCE_PROOF_VERIFIED",
  "RIDE_INSTANCE_PROOF_REJECTED",
  "RIDE_INSTANCE_FARE_ABOVE_CAP",
  "HOST_CAN_BOOK",
