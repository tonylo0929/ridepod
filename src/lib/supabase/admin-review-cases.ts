...
function payoutStatusDisplayLabel(payoutStatus: AdminReviewCase["payoutStatus"]) {
  ...
  if (payoutStatus === "READY_TO_RELEASE") return "Payout ready";
  if (payoutStatus === "RELEASED_MOCK") return "Payout released in demo";
  if (payoutStatus === "DENIED_MOCK") return "Payout denied";
