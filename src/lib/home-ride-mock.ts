...
const recurringRideAppSearchRides: HomeRide[] = [
  ...
  {
    id: "recurring-ride-app-tai-po-airport",
    ...
    direction: "Outbound",
    is_recurring: true,
    recurrence_label: "EVERY TUE",
    ride_time: "7:25 AM",
    period_label: "Morning",
    next_occurrence_label: "Tue, Aug 11",
    regular_count: 2,
    max_regulars: 4,
    seats_open: 2,
    estimated_share: 45,
