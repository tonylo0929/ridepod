...
import {
  ...
  type RideInstanceNotificationGroup,
  type RideInstanceNotificationTone,
...
export default function NotificationsPage() {
  ...
  const notifications = useMemo(() => getDemoRideInstanceNotifications(getUserPods(), "HOST"), []);
  const unreadCount = notifications.filter((notification) => !isNotificationRead(notification, readKeys)).length;
